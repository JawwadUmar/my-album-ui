...
import { getImageUrl, groupPhotosByMonth } from "../utils/helpFunctions";
...
const Gallery = () => {
  ...
  // Memoize the grouping so it doesn't recalculate on every render (like modal open/close)
  const groupedPhotos: Record<string, Photo[]> = useMemo(() => {
